...
describe SY::Dimension do
  before do
    ...
    @full_ßs = :LENGTH, :TIME, :MASS,
               :TEMPERATURE, :ELECTRIC_CHARGE
  ...
  describe ".[]" do
    it "should accept variable input" do
      ...
      SY::Dimension[ { L: 1, T: 2 } ].must_be_kind_of SY::Dimension
  ...
  describe ".zero" do
    it "constructs zero dimension" do
      SY::Dimension.zero.must_be_kind_of SY::Dimension
      SY::Dimension.zero.values.uniq.must_equal [ 0 ]
    end
  end
  ...
  describe "construction by dimension arithmetics" do
