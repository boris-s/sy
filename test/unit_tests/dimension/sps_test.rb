...
#
# File sps.rb defines class SY::Dimension::Sps, a superscripted
# product string representing dimension, such as "LENGTH.TIME⁻¹",
# "L.T⁻²", "L.TEMPERATURE⁻¹" etc. Its specification follows.
# *****************************************************************
...
describe "sy/dimension/sps.rb - dimension term string" do
  it "admits all possible symbols of base dimensions" do
