  ...
  describe "features" do
    ...
    describe "dimension arithmetics" do
      ...
      describe "addition" do
        ...
        it "should always return the same object for the same dimension" do
          assert ( SY::Dimension[ "L.M.T⁻¹" ] + SY::Dimension[ "Q.L²" ] )
                  .equal SY::Dimension[ "M.Q.L³.T⁻¹" ]
        end
      end
      ...
      describe "multiplication by an integer" do
        ...
        it "should always return the same object for the same dimension" do
          assert ( SY::Dimension[ "L.T⁻¹" ] * 2 ).equal SY::Dimension[ "L²T⁻²" ]
        end
      ...
      describe "division by an integer" do
        ...
        it "should always return the same object for the same dimension" do
          assert ( SY::Dimension[ "L⁴.M⁴" ] / 2 ).equal SY::Dimension[ "L².M²" ]
        end
    ...
    it "should always return the same instance for the same dimension" do
      assert @zero.equal SY::Dimension.zero
      assert @zero.equal SY::Dimension[ {} ]
      ...
      assert @zero.equal @L - @L
      assert @zero.equal @T - @T
